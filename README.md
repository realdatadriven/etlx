...
This is generated by ETLX automatically!<br />
{{ with .logs }}
    {{ if eq .success true }}
      <table>
        <tr>
...
ETLX integrates the [`Sprig`](https://github.com/Masterminds/sprig) library, giving your templates access to **100+ helper functions**, such as:
